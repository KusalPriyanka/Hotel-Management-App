...
import com.example.hotelmanagement.MM_Short_Eats_View;
...
public class ShortEatsAdapter extends PagerAdapter {
    ...
    public ShortEatsAdapter(List<ShortEats> models, Context context) {
        this.models = models;
